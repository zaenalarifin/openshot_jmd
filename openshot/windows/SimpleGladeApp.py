...
import os, sys, re, tokenize, inspect, weakref
...
class SimpleGladeApp:
    ...
    def __init__(self, path, root=None, domain=None, **kwargs):
        ...
        path:
            ...
            If glade_filename cannot be found, then it will be searched for relative
            to the BASE_DIR
        ...
        **kwargs:
        ...
        """        
        #if DEBUG:
        #print "SimpleGladeApp.__init__(self, %s, %s, %s)" % (path, root, domain)
        ...
        #    self.glade_path = path
        #else:
        #    self.glade_path = os.path.join(BASE_DIR, path)
        #if DEBUG:
        #    print "glade_path=%s" % self.glade_path
    ...
    def create_glade(self, glade_path, root, domain):
        #if DEBUG:
        #    print "create_glade(self, %s, %s, %s)" % (glade_path, root, domain)
